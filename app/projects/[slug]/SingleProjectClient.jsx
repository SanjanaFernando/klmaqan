...
export default function SingleProjectClient({ project, relatedProjects = [] }) {
  ...
  const keyFeatures =
    acf.key_features &&
    Array.isArray(acf.key_features) &&
    acf.key_features.length > 0
      ? acf.key_features
      : [
    ...
    <div className="luxury-page w-full bg-[#faf9f6] min-h-screen pt-24 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-4 flex flex-wrap items-center justify-between gap-4 border-b border-neutral-200">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Heart
              className={`h-3.5 w-3.5 ${liked ? "fill-current text-red-500" : "text-stone-500"}`}
            />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 rounded-md border border-neutral-200 bg-white p-6 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="font-serif-luxury font-bold text-neutral-900 text-sm">
                    {bedrooms} Beds
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-md border border-neutral-200 bg-white p-6 sm:p-8 shadow-sm">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {keyFeatures.map((feat, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 rounded-sm bg-neutral-50 p-3.5 border border-neutral-100"
                  >
            ...
            <div className="rounded-md border border-neutral-200 bg-white p-6 sm:p-8 shadow-sm">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                <div className="rounded-md border border-neutral-200 bg-stone-50 p-4">
                  ...
                  <div className="mt-1 font-serif-luxury text-2xl font-bold text-neutral-900">
                    20%
                  </div>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="rounded-md bg-neutral-950 p-6 sm:p-8 text-white border border-neutral-800 shadow-2xl">
                ...
                <p className="mt-2 text-xs text-stone-400">
                  Speak directly with an accredited property director for
                  official floor plans, unit availability, and customized
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <button
                    onClick={() => {
                      alert(
                        "Official brochure download link requested. Our team will email the PDF package.",
                      );
                    }}
              ...
              <div className="rounded-md border border-[#c5a880]/30 bg-stone-900/90 p-5 text-white">
                ...
                <p className="mt-2 text-xs text-stone-300">
                  Purchasing real estate valued at AED 2M+ qualifies you and
                  your immediate family for the 10-year renewable UAE Golden
                  Residency Visa.
                </p>
              </div>
            </div>
